// Blog HTML Generator - Converts Firestore posts to static HTML files
...
function cleanOldPosts(blogDir) {
  console.log('🧹 Cleaning old blog posts...\n');
  
  if (!fs.existsSync(blogDir)) {
    console.log('ℹ️  No /blog directory to clean\n');
    return;
  }
  ...
  if (htmlFiles.length === 0) {
    console.log('ℹ️  No HTML files to remove\n');
    return;
  }
  ...
  htmlFiles.forEach(file => {
    try {
      ...
      console.log(`🗑️  Removed: /blog/${file}`);
      removedCount++;
    } catch (error) {
  ...
  console.log(`\n✅ Cleaned ${removedCount} old file(s)\n`);
}

// Generate HTML template for a blog post
function generatePostHTML(post) {
  const categoryLabel = categoryLabels[post.category] || 'Uncategorized';
...
<head>
  ...
  <title>${post.title} - DraftaCV Blog</title>
...
<body>
  ...
  <article class="blog-post-page">
    <div id="post-content">
        ...
        <div class="post-meta">
          <div class="author-info">
            ...
            <div class="author-details">
              <span class="author-name">${post.author || 'DraftaCV Team'}</span>
      ...
      <div class="post-featured-image">
        <img src="${post.featured_image || 'https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=800&q=80'}" alt="${post.title}">
      </div>
      ...
      <div class="footer-grid">
        ...
        <div class="footer-brand">
          ...
          <div class="footer-social">
            <a href="#" id="social-whatsapp-link" target="_blank" class="social-link whatsapp" aria-label="WhatsApp">
            ...
            <a href="#" id="social-email-link" class="social-link email" aria-label="Email">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16">
                <rect width="20" height="16" x="2" y="4" rx="2"/>
                <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/>
              </svg>
            </a>
            <a href="https://discord.gg/5qdkbjT4Y2" class="social-link discord" target="_blank" aria-label="Discord">
        ...
        <div class="footer-links-col">
          ...
          <ul class="footer-links">
            <li><a href="../index.html#packages">Resume Writing</a></li>
            <li><a href="../index.html#packages">CV Design</a></li>
            <li><a href="../index.html#packages">Cover Letters</a></li>
            <li><a href="../index.html#packages">LinkedIn Optimization</a></li>
          </ul>
        </div>
        ...
        <div class="footer-links-col">
          ...
          <ul class="footer-links">
            <li><a href="../index.html#packages">Basic Starter</a></li>
            <li><a href="../index.html#packages">Professional</a></li>
            <li><a href="../index.html#packages">Executive Elite</a></li>
            <li><a href="../index.html#contact">Custom Solutions</a></li>
          </ul>
        </div>
        ...
        <div class="footer-links-col">
          ...
          <ul class="footer-links">
            <li><a href="../index.html#samples">Sample Resumes</a></li>
        ...
        <div class="footer-links-col">
          ...
          <ul class="footer-links">
            ...
            <li><a href="#" id="support-email-link">Support</a></li>
            <li><a href="#" id="footer-whatsapp-link" target="_blank">WhatsApp</a></li>
  ...
  <script>
    ...
    function shareTwitter() {
      ...
      const text = encodeURIComponent('${post.title.replace(/'/g, "\\'")}');
...
async function generateAllPosts() {
  try {
    ...
    // Clean old blog posts before generating new ones
    cleanOldPosts(blogDir);
    ...
    if (postsSnapshot.empty) {
      console.log('⚠️  No published posts found in Firestore');
      return;
    }
    
    console.log(`📝 Found ${postsSnapshot.size} published post(s)\n`);
    ...
    for (const doc of postsSnapshot.docs) {
      ...
      try {
        ...
        const filename = post.slug || post.title
          .toLowerCase()
          .replace(/[^a-z0-9]+/g, '-')
          .replace(/^-|-$/g, '');
        ...
        console.log(`✅ Generated: /blog/${filename}.html`);
        console.log(`   Title: ${post.title}`);
        console.log(`   Category: ${categoryLabels[post.category] || post.category}`);
        console.log('');
